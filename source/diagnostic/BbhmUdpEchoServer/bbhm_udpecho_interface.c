...
/**********************************************************************
    ...
    module:	bbhm_udpecho_interface.c
    ...
    description:
        ...
        general utility functions for the UDP Echo Server Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Lan Controller object.
...
{
    return  BbhmUdpechoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
