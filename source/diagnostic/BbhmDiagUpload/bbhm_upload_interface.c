...
/**********************************************************************
    ...
    module:   bbhm_upload_interface.c
    ...
    description:
        ...
        general utility functions for the Bbhm Upload Diagnostics
        Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new upload diagnostics object.
...
{
    return  BbhmUploadCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
