...
/**********************************************************************
    ...
    module:   bbhm_download_interface.c
    ...
    description:
        ...
        general utility functions for the Bbhm Download Diagnostics
        Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new download diagnostics object.
...
{
    return  BbhmDownloadCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
