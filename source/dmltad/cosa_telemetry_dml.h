...
/***********************************************************************
 APIs for Object:
 RDKCENTRAL_telemetry.

    *  Telemetry_GetParamBoolValue
    *  Telemetry_SetParamBoolValue
    *  Telemetry_GetParamIPserverStringValue
    *  Telemetry_SetParamIPserverStringValue
...
BOOL
DcmDownloadStatus_SetParamUlongValue
(
    ANSC_HANDLE                 hInsContext,
    char*                       ParamName,
    ULONG*                      pUlong
...
BOOL
DcmDownloadStatus_SetParamStringValue
(
    ANSC_HANDLE                 hInsContext,
    char*                       ParamName,
    char*                       pValue
